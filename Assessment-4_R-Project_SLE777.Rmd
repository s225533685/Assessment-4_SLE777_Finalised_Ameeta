...
The meanexpression in gene_data were ordered in the descending order using order (-)function10 genes with highest meanexpression were displayed using a drop argument. 
...
The 10 year growth values were extracted by finding difference in the circumference between 2020 and 2010 and saved in the new column. The data were separated by site to calculate the mean growth for each location and the mean() function was used fint the mean value. 
```{r}
